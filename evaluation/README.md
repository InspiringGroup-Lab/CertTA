# Evaluate Base/Certified Traffic Analysis Models
...
* `CERTIFICATION_METHOD_NAME` can be chose from CertTA, VRS, BARS and RSDel. The detailed explanation and default settings of the smoothing parameters can be found in `/CertTA_public/evaluation/opts.py` and `/CertTA_public/evaluation/config/`, respectively.
