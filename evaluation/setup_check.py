...
def main():
    ...
    print('Check the experiment setup by testing the {}-certified {} model.'.format(args.smoothed, args.model))
    ...
    one_of_k_test(args, model, test_flows[:10], 0)
